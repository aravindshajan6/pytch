...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { element: <RequireAuth allowUnonboarded />, children: [{ path: '/onboarding', element: <OnboardingPage /> }] },
      {
        path: '/app',
        element: <RequireAuth />,
        children: [
          {
            ...
            children: [
              ...
              { path: 'highlights/recordings/:recordingId', element: <RecordingPage /> },
              { path: 'weather/:alertId', element: <WeatherAlertPage /> },
